package org.fit.ssapp.extension.moea.algorithm;
...
public class PermutationCompatPSO extends AbstractAlgorithm implements Configurable {
     ...
     */
    @Getter protected Mutation mutation;
     ...
     */
    public PermutationCompatPSO(Problem problem,
                                int swarmSize,
                                int leaderSize,
        ...
        Validate.that("problem", problem).isType(Permutation.class);
    ...
    protected void updateVelocity(int i) {
        ...
        for (int j = 0; j < problem.getNumberOfVariables(); j++) {
            ...
            velocities[i][j] = W * velocities[i][j] + C1 * r1 * (localBestValue - particleValue) +
