...
/**
 * This class contains unit tests for the fitness evaluation functionality in
 * the Stable Matching Problem (SMT).
...
public class SMTUnitTestFitness {
   ...
   * @param expected        The expected result of the fitness function
   *                        evaluation.
   */
  @ParameterizedTest
  @CsvSource({
  ...
  public void testInvalidFitnessCustom(String fitnessFunction) {
    ...
    assertThrows(Exception.class, () -> evaluator.withFitnessFunctionEvaluation(satisfaction, fitnessFunction));
  }
}
