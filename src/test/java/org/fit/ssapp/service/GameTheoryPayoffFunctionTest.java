 ...
 */
public class GameTheoryPayoffFunctionTest {
    ...
    void testDefaultPayoffFunction() {
        ...
        // Default function should sum all properties
    ...
    @CsvSource({
        ...
        "ceil(p2 + 0.1), 3.0",              
        "floor(p3 - 0.1), 2.0",        
        "log(p3), 1.0986122886681098",          
        "sqrt(p3^2), 3.0"             
    })
    void testBuiltInMathOperations(String expression, double expected) {
        Strategy strategy = new Strategy();
        List<Double> properties = new ArrayList<>();
        properties.add(1.0); 
        properties.add(2.0);  
