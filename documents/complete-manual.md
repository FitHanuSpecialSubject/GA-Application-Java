...
- It's include: Problem information, Problem data.
- Note: Name the sheet correctly, or an error will occur.

2.  **Problem information**

- Problem name:
  - The name is taken from the data entered by the user.
  - Value: text
- Number of set:
  - The number of participating sets is taken from the data entered by the user.
  - Value: int
- Number of individuals:
  - The total number of individuals in each participating set is taken from the data entered by the user.
  - Value: int
- Number of characteristics:
  - The total number of attributes of the participating individuals is taken from the data entered by the user.
  - Value: int
- Fitness function :
  - A function that evaluates the suitability or effectiveness of an individual in the model.
  - Value: text (exact formula or default value)
- Evaluate Function Set_1:
  - The first set of evaluation functions used to assess or analyze individuals.
  - Value: text (exact formula or default value)
- Evaluate Function Set_2:

  - The second set of evaluation functions, which may use different criteria to assess individuals.
  - Value: text (exact formula or default value)
...
3. **Problem data**
   ...
   **3.1 Components**
   ...
   ![Example]( img1.jpg "Example")
  
   **3.2 Way to fill values**
...
- It's include: Problem information, Normal/Special player, Problem data,..
- Note: Name the sheet correctly, or an error will occur.
...
- Special Player exists:
  - Determines whether a special player exists (0: No, 1: Yes). The special player may have a significant or unique role in the game.
  - Value: int
- Number of properties of special player:
  - The number of characteristics or attributes of the special player.
  - Value: int
- Number of normal players:
  - The total number of regular players in the game.
  - Value: int
- Number of properties of each normal player :
  - The number of attributes for each normal player, which may relate to strategies, resources, or benefits.
  - Value: int
- Fitness function:
  - A function that evaluates the success of a player.
  - Value: text (exact formula or default value)
- Player payoff function:
  - A function that determines the rewards or benefits a player receives based on their strategies and actions..
  - Value: text (exact formula or default value)
- Is maximizing problem:

  - Specifies whether the problem is a maximization problem.
